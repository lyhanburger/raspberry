...
class setdevice(QMainWindow):
    ...
    def newstushow(self):
        ...
        self.ui.text_label.setPixmap(QPixmap("./img/text.png"))
    ...
    def idenshow(self):
        ...
        #self.ui.ident_samebar_pho.setFormat("未获取到照片信息")
        self.ui.ident_samebar_pho.setValue(0)
        #self.ui.ident_samebar_fin.setFormat("未获取到照片信息")
...
########################是否架设相机################################
    def setCamera(self, cameraDevice,i):
