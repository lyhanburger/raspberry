...
#!!!!!DB:从服务下载到本地数据库与!!!!!###########数据更新：用户信息跟新##########################
    ...
    def lihaoTakePhoto2(self):
        ...
        cv2.imwrite(savename, self.ui.image0)
        face_image = self.ui.image0
        face_locations = face_recognition.face_locations(self.ui.image0)
        if len(face_locations) != 0:
            top, right, bottom, left = face_locations[0]
            face_image = self.ui.image0[top:bottom, left:right]
